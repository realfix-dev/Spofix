[PSCustomObject]@{
    Welcome         = "
╔══════════════════════════════════╗
║ Välkommen till Spofix för Windows ║
╚══════════════════════════════════╝"
    ...
    Spicetify       = "Spicetify upptäckt, det måste installeras efter Spofix, öppna rekommenderade åtgärder i FAQ ? [Y/N]"
    NoRestore       = "Spofix har redan installerats, xpui.bak hittades inte. `nAvinstallera Spotify klienten och kör Install.bat igen"
