...
╚══════════════════════════════╝"
    ...
    Spicetify       = "Spicetify nájdené, musí byť inštalované po Spofix, otvoriť odporúčané akcie vo FAQ ? [Y/N]"
    NoRestore       = "Spofix už bol nainštalovaný, xpui.bak sa nenašlo. `nProsím odinštaluj Spotify klient a spusti Install.bat znova"
