[PSCustomObject]@{
    Welcome         = "
╔════════════════════════════════════════╗
║ Сардэчна запрашаем у Spofix для Windows ║
╚════════════════════════════════════════╝"
    ...
    NewV2           = "Ваша версія Spotify ({0}) не была пратэставана. Стабільная версія для Spofix — {1}"
    ...
    Spicetify       = "Spicetify выяўлены, ён павінен быць усталяваны пасля Spofix, адкрыць рэкамендаваныя дзеянні ў FAQ? [Y/N]"
    NoRestore       = "Spofix ужо ўсталяваны, xpui.bak не знойдзены. Калі ласка, выдаліце кліент Spotify і запусціце Install.bat зноў"
