...
╚════════════════════════════╝"
    ...
    Spicetify       = "Wykryto Spicetify. Należy zainstalować je po Spofix. Czy otworzyć zalecane działania w FAQ? [Y/N]"
    NoRestore       = "Spofix został już pobrany, lecz xpui.bak nie został znaleziony. `nProszę odinstalować klienta Spotify i uruchomić Install.bat ponownie"
