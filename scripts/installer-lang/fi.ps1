[PSCustomObject]@{
    Welcome         = "
╔═══════════════════════════════╗
║ Tervetuloa Spofix:n Windowsiin ║
╚═══════════════════════════════╝"
    ...
    NoRestore       = "Spofix on jo asennettu, xpui.bak tiedostoa ei löynyt. `nAsenna spotify uudelleen ja suorita Install.bat tiedosto uudelleen"
