[PSCustomObject]@{
    Welcome         = "
╔══════════════════════════════════╗
║ Bienvenue sur Spofix pour Windows ║
╚══════════════════════════════════╝"
    ...
    Spicetify       = "Spicetify détecté, il faut l'installer après Spofix, ouvrir les actions recommandées dans la FAQ ? [Y/N]"
    NoRestore       = "Spofix a déjà été installé, xpui.bak introuvable. `nMerci de désinstaller Spotify et de lancer à nouveau le script"
