...
╚═════════════════════════════╝"
    ...
    Spicetify       = "Spicetify nalezeno, musí být nainstalováno po Spofix, otevřít doporučené akce ve FAQ? [Y/N]"
    NoRestore       = "Spofix byl již nainstalován, xpui.bak se nenašlo. `nProsím odinstalujte klienta Spotify a spusťte Install.bat znovu"
