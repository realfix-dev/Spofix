...
╚══════════════════════════════╝"
    ...
    Spicetify       = "Spicetify ir konstatēts, to ir jāinstalē pēc Spofix, atvērt piemērotākos darbībus BUJ lapā? [Y/N]"
    NoRestore       = "Spofix ir jau instalēts, bet xpui.bak nebija atrasts. `nLūdzu izdzēs Spotify klientu un palaid Install.bat vēlreiz"
