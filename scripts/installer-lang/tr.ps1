[PSCustomObject]@{
    Welcome         = "
╔══════════════════════════════════╗
║ Windows için Spofix'e Hoşgeldiniz ║
╚══════════════════════════════════╝"
    ...
    NoRestore       = "Spofix zaten kurulmuş, xpui.bak dosyası bulunamadı. `nLütfen Spotify istemcisini kaldırın ve Install.bat dosyasını tekrar çalıştırın"
