[PSCustomObject]@{
    Welcome         = "
╔══════════════════════════════════════╗
║ Добро пожаловать в Spofix для Windows ║
╚══════════════════════════════════════╝"
    ...
    NewV2           = "Ваша версия Spotify ({0}) не тестировалась. Стабильная версия для Spofix — {1}"
    ...
    Spicetify       = "Обнаружен Spicetify, он должен быть установлен после Spofix, открыть рекомендуемые действия в FAQ ? [Y/N]"
    NoRestore       = "Spofix уже был установлен, но файл для восстановления xpui.bak не найден. `nУдалите клиент Spotify и снова запустите Install.bat"
