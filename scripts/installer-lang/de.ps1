[PSCustomObject]@{
    Welcome         = "
╔══════════════════════════════════╗
║ Willkommen bei Spofix für Windows ║
╚══════════════════════════════════╝"
    ...
    NoRestore       = "Spofix wurde schon installiert, xpui.bak wurde aber nicht gefunden. `nBitte deinstallieren Sie Spotify und starten Sie Install.bat nochmal"
