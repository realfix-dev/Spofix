[PSCustomObject]@{
    Welcome         = "
╔═══════════════════════════════════════════════╗
║ Maligayang pagdating sa Spofix para sa Windows ║
╚═══════════════════════════════════════════════╝"
    ...
    Spicetify       = "Nakadetect ang Spicetify, ito ay dapat na mai-install pagkatapos ng Spofix, buksan ang rekomendadong mga hakbang sa FAQ? [Y/N]"
    NoRestore       = "Nakainstall na ang Spofix, hindi nakita ang xpui.bak. `nMangyaring mag-uninstall ng Spotify client at patakbuhin muli ang Install.bat"
