[PSCustomObject]@{
    Welcome         = "
╔═══════════════════════════════╗
║ Benvenuti a Spofix per Windows ║
╚═══════════════════════════════╝"
    ...
    NewV2           = "La tua versione {0} di Spotify non è stata testata. La versione stabile per Spofix è {1}"
    ...
    Spicetify       = "Spicetify rilevato, deve essere installato dopo Spofix, aprire le azioni consigliate nelle FAQ ? [Y/N]"
    NoRestore       = "Spofix è già stato installato, xpui.bak non trovato. `nPer favore, disinstalla Spotify e riapri il file Install.bat"
